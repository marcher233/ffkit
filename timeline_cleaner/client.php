...
//////////////////////////////////////////消息相关////////////////////////////////////////////////////
	 ...
	 * page 是页数，以下都是，不再说明
     */ 
    function home_timeline($page = 1, $count = 50, $max_id = false, $id = false) 
    { 
		return $this->request_with_pager( 'http://api.fanfou.com/statuses/home_timeline.json' , $page , $count, $max_id, $id ); 
    } 

    function user_timeline($page = 1, $count = 50, $max_id = false, $id = false) 
    {
		return $this->request_with_pager( 'http://api.fanfou.com/statuses/user_timeline.json' , $page , $count, $max_id, $id ); 
    } 

    function photo_timeline($page = 1, $count = 50, $max_id = false, $id = false) 
    {
		return $this->request_with_pager( 'http://api.fanfou.com/photos/user_timeline.json' , $page , $count, $max_id, $id ); 
    } 

    function fav_timeline($page = 1, $count = 50, $max_id = false, $id = false) 
    {
		return $this->request_with_pager( 'http://api.fanfou.com/favorites/id.json' , $page , $count, $max_id, $id ); 
    } 

	function search_timeline($page = 1, $count = 50, $max_id = false, $id = false, $query, $format = 'html') 
    {
		return $this->request_with_pager( 'http://api.fanfou.com/search/user_timeline.json' , $page , $count, $max_id, $id, $query, $format ); 
    } 

    function dmr_timeline($page = 1, $count = 50, $max_id = false) 
    {
		return $this->request_with_pager( 'http://api.fanfou.com/direct_messages/inbox.json' , $page , $count, $max_id ); 
    } 

    function dms_timeline($page = 1, $count = 50, $max_id = false) 
    {
		return $this->request_with_pager( 'http://api.fanfou.com/direct_messages/sent.json' , $page , $count, $max_id ); 
    } 

    function user_photos($page = 1, $count = 50, $max_id = false, $id = false) 
    {
		return $this->request_with_pager( 'http://api.fanfou.com/photos/user_timeline.json' , $page , $count, $max_id, $id ); 
    } 

    function user_favs($page = 1, $count = 50, $max_id = false, $id = false) 
    {
		return $this->request_with_pager( 'http://api.fanfou.com/favorites/id.json' , $page , $count, $max_id, $id ); 
    } 
...
//////////////////////////////////////用户相关////////////////////////////////////////////
     ...
     * @return array 
     */ 
    function destroy_favorites( $sid ) 
    {
		$param = array();
		$param['id'] = $sid;		
        return $this->oauth->post( 'http://api.fanfou.com/favorites/destroy/id.json', $param ); 
    }
     ...
     * @ignore 
     */ 
    protected function request_with_pager( $url , $page = false , $count = false , $max_id = false , $id = false, $query = false, $format = false ) 
    { 
		$param = array(); 
		if( $page ) $param['page'] = $page; 
		if( $count ) $param['count'] = $count; 
